...
def jobList = [new MyJob("${mongo_primary_instance_id}",'mongo-primary',15),
               new MyJob("${mongo_secondary_instance_id}",'mongo-secondary',15),
               new MyJob("${mongo_arbitor_instance_id}",'mongo-heavy-arbitor',15)
]
