...
artifact_url=http://nexus.mettl.com:8081/nexus/content/repositories/${base_nexus_url}${component}/$release_num/$component-$release_num-$component.zip
echo "will download from $artifact_url"


# web app base
APP_BASE=/home/mettl/volume1/serviceAssesmblies/$component/current-installation
echo "Deploying $component to $APP_BASE ........"
